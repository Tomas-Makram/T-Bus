...
namespace BusinessLayer.Services
{
    ...
    public class TokenSessionService : ITokenSessionService
    {
        ...
        private string GenerateAccessToken(Users user, Guid sessionId, DateTime expireAt)
        {
            var claims = new List<Claim>
            {
                new Claim(ClaimTypes.NameIdentifier, user.UserId.ToString()),
                new Claim(ClaimTypes.Name, user.UserName),
                new Claim(ClaimTypes.Role, user.RoleEncrypted.ToString() ?? "Driver"),
                new Claim("session_id", sessionId.ToString()),
                new Claim("driver_id", user.DriverId.ToString() ?? string.Empty),
